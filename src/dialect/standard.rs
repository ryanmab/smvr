...
mod tests {
    ...
    fn should_move_to_minor_from_major() {
        let result = Standard::parse_byte(b'.', (PartType::Major, &vec![b'1']), b"12").unwrap();
    ...
    fn should_fail_non_numerics_in_major() {
        let result = Standard::parse_byte(b'a', (PartType::Major, &vec![b'1']), b"12");
    ...
    fn should_fail_non_numerics_in_minor() {
        let result = Standard::parse_byte(b'a', (PartType::Minor, &vec![]), b"12");
    ...
    fn should_fail_using_dot_after_patch() {
        let result = Standard::parse_byte(b'.', (PartType::Patch, &vec![b'9']), b"12");
    ...
    fn should_fail_non_numerics_in_patch() {
        let result = Standard::parse_byte(b'a', (PartType::Patch, &vec![b'9']), b"12");
